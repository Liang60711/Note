...
public List<UserOperationLog> getListWithParam(UserOperationLogParam param) throws IOException {
        ...
        Specification<UserOperationLog> specification = (Specification<UserOperationLog>) (root, criteriaQuery, criteriaBuilder) -> {

            List<Predicate> predicatesList = new ArrayList<>();

            // param 為篩選條件物件
            // 這邊因為資料結構，不使用 join
            if (param.getUserAccount() != null || param.getAliasName() != null) {
